...
API_ID = int(environ.get('API_ID', '27988117'))
API_HASH = environ.get('API_HASH', '771117c9f555aa7bc6fb9528897df470')
BOT_TOKEN = environ.get('BOT_TOKEN', "7231024537:AAHLtB0z7Hre-GMkij52nuMAS--Uem3znKo")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1606227668').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1606227668').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '')
auth_grp = environ.get('AUTH_GROUP','-1002175442980')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Masudranaanik:<Anikisla1>@cluster0.a5gq7xl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
